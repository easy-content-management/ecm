...
ActiveRecord::Schema.define(version: 2019_03_01_132158) do
  ...
  create_table "ecm_blog_asset_details", force: :cascade do |t|
    t.integer "post_id"
    t.integer "asset_id"
    t.string "title"
    t.text "description"
    ...
    t.index ["asset_id"], name: "index_ecm_blog_asset_details_on_asset_id"
    t.index ["post_id"], name: "index_ecm_blog_asset_details_on_post_id"
  end
  ...
  create_table "ecm_blog_posts", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "position"
    t.index ["slug"], name: "index_ecm_blog_posts_on_slug", unique: true
  end
  ...
  create_table "ecm_carousels_item_details", force: :cascade do |t|
  ...
  create_table "ecm_files_file_details", force: :cascade do |t|
    t.integer "folder_id"
    t.integer "asset_id"
    t.string "title"
    t.text "description"
  ...
  create_table "ecm_files_folders", force: :cascade do |t|
    t.string "name"
    t.datetime "published_at"
    t.text "description"
    t.datetime "created_at", null: false
