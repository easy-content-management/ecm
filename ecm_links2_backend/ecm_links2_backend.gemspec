...
Gem::Specification.new do |s|
  s.name        = 'ecm_links2_backend'
  s.version     = Ecm::VERSION
  s.authors     = ['Roberto Vasquez Angel']
  s.email       = ['roberto@vasquez-angel.de']
  s.homepage    = 'https://github.com/robotex82/ecm_links2_backend'
  s.summary     = 'Backend Module for ECM Links 2'
  s.description = 'Provides a ITSF Backend based Backend for ECM Links 2'
  s.license     = 'MIT'
